...
<div class="<?php echo $class_add;?>">
    <div class="form-group">
        <input id="search_option_quick" type="text" class="form-control typeahead_autocomplete" value="{search_query}" placeholder="<?php echo lang_check('I’m looking for...');?>" autocomplete="off" />
    </div>
</div>